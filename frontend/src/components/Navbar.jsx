...
// import SearchBar from './SearchBar'; // 👈 Dynamic SearchBar Imported
// import { useAuth } from '../context/AuthContext'; // 👈 AuthContext Imported
...
//   const { user, logoutUser } = useAuth(); // 👈 User details & Logout function
//   const navigate = useNavigate();

//   // User Initial Letter (e.g. "Koms" -> "K")
...
//         {/* 👤 Dynamic Auth Logic: Avatar or Sign In Button */}
//         {user ? (
...
import { Link, useNavigate } from 'react-router-dom';
import { Film, Tv, TrendingUp, Compass, Flame, Star, ChevronDown, Disc, Tv2, Heart, LogOut } from 'lucide-react';
import SearchBar from './SearchBar'; // 👈 Dynamic SearchBar
import { useAuth } from '../context/AuthContext'; // 👈 AuthContext Imported
